...
def speaker(file):  # vom Dateinamen
  # if not "_" in file:
  #   return "Unknown"
  #print("speaker::::"+str(file.split("_")[0]))
  return file.split("-")[0]
...
def get_speakers(path):
  ...
  def nobad(file):
    #print("nobad:"+str("_" in file and not "." in file.split("_")[0]))
    #return "-" in file and not "." in file.split("_")[0]
    return "-" in file and not "." in file.split("-")[0]
